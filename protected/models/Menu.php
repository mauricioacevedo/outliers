...
class Menu extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('module_id, foreign_module_id, parent_id, menu_name, menu_type, order_menu, name, description, icon, icon_height, icon_width, idbtn, param, class, style, title, langCode, dir, href, hrefLang, type, rel, rev, shape, coords, target, tabIndex, accessKey, events, publish, access, link, action, controller', 'filter', 'filter'=>'trim'),
			...
			array('id, module_id, parent_id, menu_name, menu_type, order_menu, name, description, icon, icon_height, icon_width, idbtn, param, class, style, title, langCode, dir, href, hrefLang, type, rel, rev, shape, coords, target, tabIndex, accessKey, events, publish, access, link, action, controller', 'safe', 'on'=>'search'),
		);
	}
