...
/**
 * This is the model class for table "prueba3".
 *
 * The followings are the available columns in table 'prueba3':
 * @property integer $id
 */
class Prueba3 extends CActiveRecord
{
	 ...
	 * @return Prueba3 the static model class
	 */
