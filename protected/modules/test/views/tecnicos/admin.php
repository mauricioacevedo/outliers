...
$this->widget('bootstrap.widgets.TbExtendedGridView', array(
	...
	'columns'=>array(
		...
		array(
                        ...
                        'viewButtonUrl'=>'Yii::app()->createUrl("/tecnicos/view&id=$data->id" )', // url de la acción 'viw'
                        'updateButtonUrl'=>'Yii::app()->createUrl("/tecnicos/update&id=$data->id" )', // url de la acción 'update'
                        'deleteButtonUrl'=>'Yii::app()->createUrl("/tecnicos/delete&id=$data->id" )', // url de la acción 'delete'
