		...
		$this->render('index',array(
			'dataProvider'=>$dataProvider,
                   ...
                   $dataProvider = $model->search(false);
                    ...
                    $headers = array('id','identificacion','nombre','creadopor','modificadopor','fechamodificacion','fechacreacion','contrato'); 
                    $html = '<style>
                                table
                                {
                    ...
                    foreach($headers as $field) {
                        $arrLabels[] = Tecnicos::model()->getAttributeLabel($field);
                        $html .= '<td style="text-align:center; font-weight: bold;">'.Tecnicos::model()->getAttributeLabel($field).'</td>';
                    }           
                    $html .= '</tr>';
                    $lines = '';
