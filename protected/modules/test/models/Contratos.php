...
class Contratos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('contrato, creadopor, modificadopor, fechamodificacion, fechacreacion', 'filter', 'filter'=>'trim'),
			array('contrato', 'required'),
			array('contrato, creadopor, modificadopor', 'length', 'max'=>100),
			...
			array('id, contrato, creadopor, modificadopor, fechamodificacion, fechacreacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'evidenciases' => array(self::HAS_MANY, 'Evidencias', 'contrato'),
		);
	}
