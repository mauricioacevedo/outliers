 ...
 * @property TblPermitRequest[] $tblPermitRequests
 */
class TblProfiles extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name_profile, description, creadopor, fechacreacion, modificadopor, fechamodificacion', 'filter', 'filter'=>'trim'),
			array('name_profile', 'length', 'max'=>255),
			array('creadopor, modificadopor', 'length', 'max'=>100),
			array('description, fechacreacion, fechamodificacion', 'safe'),
			...
			array('id_profile, name_profile, description, creadopor, fechacreacion, modificadopor, fechamodificacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tblPermitRequests' => array(self::HAS_MANY, 'TblPermitRequest', 'profile_id'),
		);
	}
	...
	public function search($pagination = array( 'pageSize'=>10))
	{
		...
		$criteria->compare('name_profile',$this->name_profile,true);
		$criteria->compare('description',$this->description,true);
		$criteria->compare('creadopor',$this->creadopor,true);
		$criteria->compare('fechacreacion',$this->fechacreacion,true);
		$criteria->compare('modificadopor',$this->modificadopor,true);
		$criteria->compare('fechamodificacion',$this->fechamodificacion,true);
               $criteria->with = array(               			'tblPermitRequests'=>array('select'=>'id_profile'),                          
               );           
                $sort = new CSort();
                $sort->attributes = array('id_profile');
                $sort->defaultOrder = array('id_profile' => 'DESC');
