...
class Solucion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, solucion, creadopor, modificadopor, fechamodificacion, fechacreacion', 'filter', 'filter'=>'trim'),
			array('id, solucion', 'required'),
			array('id', 'numerical', 'integerOnly'=>true),
			array('solucion', 'length', 'max'=>300),
			...
			array('id, solucion, creadopor, modificadopor, fechamodificacion, fechacreacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'evidenciases' => array(self::HAS_MANY, 'Evidencias', 'solucion'),
		);
	}
