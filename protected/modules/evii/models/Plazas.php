 ...
 *
 * The followings are the available columns in table 'plazas':
 * @property integer $id
 ...
 */
class Plazas extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, plaza, creadopor, modificadopor, fechamodificacion, fechacreacion', 'filter', 'filter'=>'trim'),
			array('id, plaza', 'required'),
			array('id', 'numerical', 'integerOnly'=>true),
			array('plaza, creadopor, modificadopor', 'length', 'max'=>100),
			...
			array('id, plaza, creadopor, modificadopor, fechamodificacion, fechacreacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'evidenciases' => array(self::HAS_MANY, 'Evidencias', 'plaza'),
		);
	}
	 ...
	 * @return Plazas the static model class
	 */
