...
/**
 * This is the model class for table "evidenciasxdiagnosticotecnico".
 *
 * The followings are the available columns in table 'evidenciasxdiagnosticotecnico':
 ...
 * @property Diagnosticotecnico $diagnostico
 * @property Evidencias $evidencia
 */
class Evidenciasxdiagnosticotecnico extends CActiveRecord
{
    public $foreign_evidencia_id;
    public $foreign_diagnostico_id;
	...
	{
		return 'evidenciasxdiagnosticotecnico';
	}
	...
	public function rules()
	{
		...
		return array(
			array('evidencia_id, foreign_evidencia_id, diagnostico_id, foreign_diagnostico_id, creadopor, modificadopor, fechamodificacion, fechacreacion', 'filter', 'filter'=>'trim'),
			array('evidencia_id, diagnostico_id', 'required'),
			array('evidencia_id, diagnostico_id', 'numerical', 'integerOnly'=>true),
			...
			array('evidencia_id, diagnostico_id, creadopor, modificadopor, fechamodificacion, fechacreacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'diagnostico' => array(self::BELONGS_TO, 'Diagnosticotecnico', 'diagnostico_id'),
	...
	public function attributeLabels()
	{
		return array(
                                   ...
                                   'foreign_diagnostico_id' => 'Diagnostico',
	...
	public function search($pagination = array( 'pageSize'=>10))
	{
		...
		$criteria->compare('diagnostico.diagnostico_id',$this->diagnostico_id,true);
		$criteria->compare('creadopor',$this->creadopor,true);
		$criteria->compare('modificadopor',$this->modificadopor,true);
		$criteria->compare('fechamodificacion',$this->fechamodificacion,true);
		$criteria->compare('fechacreacion',$this->fechacreacion,true);
               $criteria->with = array(               			'diagnostico'=>array('select'=>'id'),               			'evidencia'=>array('select'=>'id'),                          
               );           
                $sort = new CSort();
	 ...
	 * @return Evidenciasxdiagnosticotecnico the static model class
	 */
