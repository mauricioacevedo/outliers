 ...
 *
 * The followings are the available columns in table 'hallazgos':
 * @property integer $id
 ...
 */
class Hallazgos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, hallazgo, creadopor, modificadopor, fechamodificacion, fechacreacion', 'filter', 'filter'=>'trim'),
			array('id, hallazgo', 'required'),
			array('id', 'numerical', 'integerOnly'=>true),
			array('hallazgo', 'length', 'max'=>300),
			...
			array('id, hallazgo, creadopor, modificadopor, fechamodificacion, fechacreacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'evidenciases' => array(self::HAS_MANY, 'Evidencias', 'hallazgos'),
		);
	}
	...
	public function search($pagination = array( 'pageSize'=>10))
	{
		...
		$criteria->compare('hallazgo',$this->hallazgo,true);
	 ...
	 * @return Hallazgos the static model class
	 */
