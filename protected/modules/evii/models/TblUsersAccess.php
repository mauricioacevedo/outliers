 ...
 */
class TblUsersAccess extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('samaccountname, ip, date_access, sessionid, datecreate, creadopor, fechacreacion, modificadopor, fechamodificacion', 'filter', 'filter'=>'trim'),
			array('samaccountname, sessionid, creadopor, modificadopor', 'length', 'max'=>100),
			array('ip', 'length', 'max'=>20),
			array('date_access, datecreate, fechacreacion, fechamodificacion', 'safe'),
			...
			array('id, samaccountname, ip, date_access, sessionid, datecreate, creadopor, fechacreacion, modificadopor, fechamodificacion', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TblUsersAccess the static model class
	 */
