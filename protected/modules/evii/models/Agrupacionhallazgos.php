...
/**
 * This is the model class for table "agrupacionhallazgos".
 *
 * The followings are the available columns in table 'agrupacionhallazgos':
 * @property integer $id
 ...
 */
class Agrupacionhallazgos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, agrupador, creadopor, modificadopor, fechamodificacion, fechacreacion', 'filter', 'filter'=>'trim'),
			array('id, agrupador', 'required'),
			array('id', 'numerical', 'integerOnly'=>true),
			array('agrupador, creadopor, modificadopor', 'length', 'max'=>100),
			...
			array('id, agrupador, creadopor, modificadopor, fechamodificacion, fechacreacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'evidenciases' => array(self::HAS_MANY, 'Evidencias', 'agrupacion_hallazgos'),
		);
	}
	...
	public function search($pagination = array( 'pageSize'=>10))
	{
		...
		$criteria->compare('agrupador',$this->agrupador,true);
	 ...
	 * @return Agrupacionhallazgos the static model class
	 */
