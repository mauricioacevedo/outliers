...
class Productos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, producto, creadopor, modificadopor, fechamodificacion, fechacreacion', 'filter', 'filter'=>'trim'),
			array('id, producto', 'required'),
			array('id', 'numerical', 'integerOnly'=>true),
			array('producto, creadopor, modificadopor', 'length', 'max'=>100),
			...
			array('id, producto, creadopor, modificadopor, fechamodificacion, fechacreacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'evidenciases' => array(self::HAS_MANY, 'Evidencias', 'producto'),
		);
	}
