...
class TblLayout extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('layout, creadopor, fechacreacion, modificadopor, fechamodificacion', 'filter', 'filter'=>'trim'),
			...
			array('id, layout, creadopor, fechacreacion, modificadopor, fechamodificacion', 'safe', 'on'=>'search'),
		);
	}
