...
/**
 * This is the model class for table "tbl_notificationtype".
 *
 * The followings are the available columns in table 'tbl_notificationtype':
 * @property integer $id
 ...
 */
class TblNotificationtype extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('noty_desc, creadopor, fechacreacion, modificadopor, fechamodificacion', 'filter', 'filter'=>'trim'),
			...
			array('id, noty_desc, creadopor, fechacreacion, modificadopor, fechamodificacion', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TblNotificationtype the static model class
	 */
