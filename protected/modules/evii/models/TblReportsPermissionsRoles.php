 ...
 * @property TblUsers $creadopor0
 * @property TblUsers $modificadopor0
 */
class TblReportsPermissionsRoles extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'creadopor0' => array(self::BELONGS_TO, 'TblUsers', 'creadopor'),
			'modificadopor0' => array(self::BELONGS_TO, 'TblUsers', 'modificadopor'),
		);
	}
	 ...
	 * @return TblReportsPermissionsRoles the static model class
	 */
