 ...
 */
class TblHelp extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('controller, action, title, content, creadopor, fechacreacion, modificadopor, fechamodificacion, create_by, create_date, modified_by, modified_date', 'filter', 'filter'=>'trim'),
			array('controller, action', 'required'),
			array('controller, action, creadopor, modificadopor, create_by, modified_by', 'length', 'max'=>100),
			array('title', 'length', 'max'=>300),
			array('content, fechacreacion, fechamodificacion, create_date, modified_date', 'safe'),
			...
			array('help_id, controller, action, title, content, creadopor, fechacreacion, modificadopor, fechamodificacion, create_by, create_date, modified_by, modified_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search($pagination = array( 'pageSize'=>10))
	{
		...
		$criteria->compare('modified_date',$this->modified_date,true);
                ...
                $sort = new CSort();
                $sort->attributes = array('help_id');
                $sort->defaultOrder = array('help_id' => 'DESC');
	 ...
	 * @return TblHelp the static model class
	 */
