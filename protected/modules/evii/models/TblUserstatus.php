 ...
 *
 * The followings are the available columns in table 'tbl_userstatus':
 * @property integer $id
 ...
 */
class TblUserstatus extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('status, creadopor, fechacreacion, modificadopor, fechamodificacion', 'filter', 'filter'=>'trim'),
			...
			array('id, status, creadopor, fechacreacion, modificadopor, fechamodificacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tblUsers' => array(self::HAS_MANY, 'TblUsers', 'user_status'),
		);
	}
	...
	public function search($pagination = array( 'pageSize'=>10))
	{
		...
		$criteria->compare('fechamodificacion',$this->fechamodificacion,true);
               $criteria->with = array(               			'tblUsers'=>array('select'=>'id'),                          
               );           
                $sort = new CSort();
	 ...
	 * @return TblUserstatus the static model class
	 */
