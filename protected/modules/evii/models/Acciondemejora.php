...
/**
 * This is the model class for table "acciondemejora".
 *
 * The followings are the available columns in table 'acciondemejora':
 * @property integer $id
 ...
 */
class Acciondemejora extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('accion, creadopor, modificadopor, fechamodificacion, fechacreacion', 'filter', 'filter'=>'trim'),
            array('accion', 'required'),
            array('accion', 'length', 'max'=>300),
            ...
            array('id, accion, creadopor, modificadopor, fechamodificacion, fechacreacion', 'safe', 'on'=>'search'),
        );
    }
     ...
     * @return Acciondemejora the static model class
     */
