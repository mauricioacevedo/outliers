...
/**
 * This is the model class for table "responsabledano".
 *
 * The followings are the available columns in table 'responsabledano':
 * @property integer $id
 * @property string $responsable_dano
 ...
 */
class Responsabledano extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, responsable_dano, creadopor, modificadopor, fechamodificacion, fechacreacion', 'filter', 'filter'=>'trim'),
			array('id, responsable_dano', 'required'),
			array('id', 'numerical', 'integerOnly'=>true),
			array('responsable_dano, creadopor, modificadopor', 'length', 'max'=>100),
			...
			array('id, responsable_dano, creadopor, modificadopor, fechamodificacion, fechacreacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'evidenciases' => array(self::HAS_MANY, 'Evidencias', 'responsable_dano'),
		);
	}
	...
	public function search($pagination = array( 'pageSize'=>10))
	{
		...
		$criteria->compare('responsable_dano',$this->responsable_dano,true);
	 ...
	 * @return Responsabledano the static model class
	 */
