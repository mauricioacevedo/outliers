...
/**
 * This is the model class for table "tbl_import_data".
 *
 * The followings are the available columns in table 'tbl_import_data':
 * @property integer $id
 * @property string $bd
 * @property string $tabla
 * @property string $alias
 * @property integer $eliminable
 * @property string $creadopor
 * @property string $fechacreacion
 * @property string $modificadopor
 * @property string $fechamodificacion
 */
class TblImportData extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('bd, tabla, alias, eliminable, creadopor, fechacreacion, modificadopor, fechamodificacion', 'filter', 'filter'=>'trim'),
			array('eliminable', 'numerical', 'integerOnly'=>true),
			array('bd, tabla, alias', 'length', 'max'=>255),
			...
			array('id, bd, tabla, alias, eliminable, creadopor, fechacreacion, modificadopor, fechamodificacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search($pagination = array( 'pageSize'=>10))
	{
		...
		$criteria->compare('eliminable',$this->eliminable);
	 ...
	 * @return TblImportData the static model class
	 */
