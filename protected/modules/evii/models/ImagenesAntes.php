...
/**
 * This is the model class for table "imagenes_antes".
 *
 * The followings are the available columns in table 'imagenes_antes':
 * @property integer $id
 ...
 */
class ImagenesAntes extends CActiveRecord
{
	 ...
	 * @return ImagenesAntes the static model class
	 */
