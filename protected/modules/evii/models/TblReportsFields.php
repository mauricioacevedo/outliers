 ...
 * @property TblReportsFieldType $fieldType
 */
class TblReportsFields extends CActiveRecord
{
    public $foreign_report_id;
    public $foreign_field_type_id;
	...
	public function relations()
	{
		...
		return array(
			...
			'fieldType' => array(self::BELONGS_TO, 'TblReportsFieldType', 'field_type_id'),
		);
	}
	...
	{
		return array(
                                   'foreign_report_id' => 'Id del informe relacionado con la tabla tbl_informes',
                                   'foreign_field_type_id' => 'Id del Tipo de campo que se encuentra en la tabla tbl_p_tipo_campo_form',
	...
	public function search($pagination = array( 'pageSize'=>10))
	{
		...
		$criteria->compare('fieldType.field_type_id',$this->field_type_id,true);
		...
		$criteria->compare('fechamodificacion',$this->fechamodificacion,true);
               $criteria->with = array(               			'report'=>array('select'=>'report'),               			'fieldType'=>array('select'=>'field_type'),                          
               );           
                $sort = new CSort();
                $sort->attributes = array('field_id');
                $sort->defaultOrder = array('field_id' => 'DESC');
	 ...
	 * @return TblReportsFields the static model class
	 */
