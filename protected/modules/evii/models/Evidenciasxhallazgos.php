...
/**
 * This is the model class for table "evidenciasxhallazgos".
 *
 * The followings are the available columns in table 'evidenciasxhallazgos':
 * @property integer $evidencia_id
 * @property integer $hallazgo_id
 ...
 * @property Hallazgos $hallazgo
 */
class Evidenciasxhallazgos extends CActiveRecord
{
    public $foreign_evidencia_id;
    public $foreign_hallazgo_id;
	...
	public function rules()
	{
		...
		return array(
			array('evidencia_id, foreign_evidencia_id, hallazgo_id, foreign_hallazgo_id, creadopor, modificadopor, fechamodificacion, fechacreacion', 'filter', 'filter'=>'trim'),
			array('evidencia_id, hallazgo_id', 'required'),
			array('evidencia_id, hallazgo_id', 'numerical', 'integerOnly'=>true),
			...
			array('evidencia_id, hallazgo_id, creadopor, modificadopor, fechamodificacion, fechacreacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'hallazgo' => array(self::BELONGS_TO, 'Hallazgos', 'hallazgo_id'),
		);
	}
	...
	public function search($pagination = array( 'pageSize'=>10))
	{
		...
		$criteria->compare('hallazgo.hallazgo_id',$this->hallazgo_id,true);
		$criteria->compare('creadopor',$this->creadopor,true);
		$criteria->compare('modificadopor',$this->modificadopor,true);
		$criteria->compare('fechamodificacion',$this->fechamodificacion,true);
		$criteria->compare('fechacreacion',$this->fechacreacion,true);
               $criteria->with = array(               			'evidencia'=>array('select'=>'id'),               			'hallazgo'=>array('select'=>'id'),                          
               );           
                $sort = new CSort();
	 ...
	 * @return Evidenciasxhallazgos the static model class
	 */
