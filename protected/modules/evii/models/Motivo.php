...
class Motivo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, motivo, creadopor, modificadopor, fechamodificacion, fechacreacion', 'filter', 'filter'=>'trim'),
			array('id, motivo', 'required'),
			...
			array('id, motivo, creadopor, modificadopor, fechamodificacion, fechacreacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'evidenciases' => array(self::HAS_MANY, 'Evidencias', 'motivo_outlier'),
		);
	}
