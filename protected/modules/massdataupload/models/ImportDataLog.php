...
/**
 * This is the model class for table "mvc_import_data_log".
 *
 * The followings are the available columns in table 'mvc_import_data_log':
 * @property integer $id
...
class ImportDataLog extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('import_date, content', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, module_id, cod_response, process, import_date, user, content', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ImportDataLog the static model class
	 */
