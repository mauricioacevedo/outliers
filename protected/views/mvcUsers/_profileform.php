...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php #echo $form->textField($model,'samaccountname',array('size'=>60,'maxlength'=>255,'class'=>'span4')); ?>
		<?php #echo $form->error($model,'samaccountname'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'employeenumber'); ?>
		<?php echo $form->textField($model,'employeenumber',array('size'=>60,'maxlength'=>255,'class'=>'span4')); ?>
		<?php echo $form->error($model,'employeenumber'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'departmentnumber'); ?>
		<?php echo $form->textField($model,'departmentnumber',array('size'=>60,'maxlength'=>255,'class'=>'span4')); ?>
		<?php echo $form->error($model,'departmentnumber'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'department'); ?>
		<?php echo $form->textField($model,'department',array('size'=>60,'maxlength'=>255,'class'=>'span4')); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'cn',array('size'=>60,'maxlength'=>255,'class'=>'span4')); ?>
		<?php echo $form->error($model,'cn'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'mail'); ?>
		<?php echo $form->textField($model,'mail',array('size'=>60,'maxlength'=>255,'class'=>'span4')); ?>
