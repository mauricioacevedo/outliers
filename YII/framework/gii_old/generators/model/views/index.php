...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'extraRules'); ?>
		<?php echo $form->textArea($model,'extraRules', array('rows' => 7, 'style' => 'width:100%')); ?>
		<div class="tooltip">
			Add extra rules for the model
		</div>
		<?php echo $form->error($model,'extraRules'); ?>
	</div>
	<div class="row">
